...
const App = () => {
        ...
        const fetchRates = async () => {
            try {
                ...
                if (docSnap.exists()) {
                    ...
                    const allRates = { ...data, 'TRY': 1 };
                    setRates(allRates);
                } else {
                    setRatesError("Kur verisi bulunamadı.");
                }
            } catch (err) {
    ...
    const handleCurrencyDisplayClick = () => {
        setActiveView('currencyConverter');
    }
    ...
    const menuItems = [
        ...
        { id: 'currencyConverter', title: 'Döviz Çevirici' },
        ...
        { id: 'requestForm', title: 'İstek & Öneri' },
    ];
    ...
    const renderActiveView = () => {
        ...
        switch (activeView) {
            ...
            case 'currencyConverter':
                return <CurrencyConverter {...props} rates={rates} loading={ratesLoading} error={ratesError} />;
            default:
                return <ProfitCalculator {...props} />;
        }
    };
    ...
    return (
        <div style={styles.safeArea}>
            ...
            <CurrencyDisplay 
                ...
                error={ratesError} 
                onClick={handleCurrencyDisplayClick}
            />
